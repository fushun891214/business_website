...
<body>
  ...
  <nav class="navbar navbar-light custom-navbar">
    <div class="container">
      <a class="navbar-brand" href="user_index.html">東吳拍賣站</a>
  ...
  <nav class="navbar navbar-light custom-navbar">
    <div class="container">
      <a href="user_index.html">
        <svg href="assets/img/arrow-left-circle.svg" width="50" height="50" fill="currentColor" class="bi bi-arrow-left-circle" viewBox="0 0 16 16">
      ...
      <div class="container">
        <div class="row mb-4 align-items-center">
          <div class="col-md-6" data-aos="fade-up">
            <h2>AirPods 破 吐</h2>
            <p>Apple 設計 H2 Apple 晶片，適應性等化功能帶來出色音質</p>
          </div>
        </div>
      </div>
        ...
        <div class="container">
          <div class="row align-items-stretch">
            <div class="col-md-8" data-aos="fade-up">
              <img src="assets/img/user_index_Group 1.jpg" alt="Image" class="img-fluid">
            </div>
            <div class="col-md-3 ml-auto" data-aos="fade-up" data-aos-delay="100">
              <div class="sticky-content">
                <h3 class="h3">AirPods 破 吐</h3>
                <p class="mb-4"><span class="text-muted">商品介紹</span></p>

                <div class="mb-5">
                  <p>•主動式降噪功能可降低擾人的背景噪音</p>
                  <p>•多種耳塞套尺寸 (XS、S、M、L)</p>
                  <p>•AirPods Pro 與充電盒具備抗汗抗水功能</P>
                  <p>•MagSafe 充電盒配備揚聲器與掛繩孔</P>
                  <p>•說聲「嘿 Siri」即可快速啟用 Siri</p>
                  <p>•簡易的設定、入耳偵測，以及在裝置間自動切換</p>
                </div>

                <p><a href="user_shopping_cart1.html" class="readmore">加入購物車</a></p>
              </div>
            </div>
          </div>
        </div>
